...
class PlanarFractionalBrownianSurface:
    ...
    """
    def __init__(self, a_x, a_y, n_fbm_density=64, H=0.5, num_components=10, seed=42, verbose=True):
        """
        Parameters
        ----------
        a_x: float
        ...
        self.fBm_directions[0, :] = np.cos(alpha*np.arange(num_components))
        self.fBm_directions[1, :] = np.sin(alpha*np.arange(num_components))
